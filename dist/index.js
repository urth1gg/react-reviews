...
const Reviews = ({ reviews, pathToIcon, className, _ReviewComponent, classNameContainer }) => {
    ...
    return (React.createElement("div", { className: "text-white relative" },
        ...
        React.createElement(TransitionGroup$1, { className: `flex gap-3 w-full justify-center items-center ${classNameContainer}` }, visibleReviews.map((review) => (React.createElement(CSSTransition$1, { key: review.id, timeout: 700, classNames: "review" }, _ReviewComponent ? (React.createElement(_ReviewComponent, { review: review })) : (React.createElement(ReviewComponent, { review: review, pathToIcon: pathToIcon, className: className })))))),
        React.createElement("div", { className: 'text-center mt-3' },
            React.createElement("button", { className: " text-white font-bold rounded mr-3 bg-blue-300 p-3", onClick: handlePrevClick },
                React.createElement("img", { src: img, alt: "left", className: 'max-w-[30px]' })),
            React.createElement("button", { className: " text-white font-bold rounded bg-blue-300 p-3", onClick: handleNextClick },
                React.createElement("img", { src: img$1, alt: "right", className: 'max-w-[30px]' })))));
};
