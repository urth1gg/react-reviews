...
export const ReviewForm: React.FC<ReviewFormComponentProps> = ({ onSubmit }) => {
        ...
        <form onSubmit={handleSubmit} className="max-w-md mx-auto">
            ...
            <div className="mb-4">
                ...
                <input
                    ...
                    className="w-full px-3 py-2 text-white bg-main-light rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    required
                />
            </div>
            <div className="mb-4">
                ...
                <textarea
                    ...
                    className="w-full px-3 py-2 text-white bg-main-light rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 min-h-[200px]"
                    required
                ></textarea>
            </div>
            <div className="mb-4">
